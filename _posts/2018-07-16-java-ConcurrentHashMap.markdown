...
> 设计ConcurrentHashMap的动机：在高并发的环境下，如果使用的是HashMap，当多条线程同时进行rehash的时候，容易出现链表成环的现象。具体参考博客：[hashmap的问题](https://blog.csdn.net/dgutliangxuan/article/details/78779448)|[hashmap问题1](https://www.cnblogs.com/andy-zhou/p/5402984.html)
